...
<body>
    ...
    <div class="limiter" style="background-color: #ebeeef">
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form" action="/registerUser" onsubmit="return validate()" method="post">
                    ...
                    <div class="wrap-input100 validate-input m-b-26" data-validate="First Name is required">
                        ...
                        <input class="input100" type="text" id="fname" name="firstName" value="" placeholder="Enter First Name">
                    ...
                    <div class="wrap-input100 validate-input m-b-18" data-validate="Last Name is required">
                        ...
                        <input class="input100" type="text" name="lastName" id="lname" value="" placeholder="Enter Last Name">
                        <span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input m-b-26" data-validate="User Name is required">
                        ...
                        <input class="input100" type="text" id=" " name="userName" value="" placeholder="User First Name">
                        <span class="focus-input100"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-b-26" data-validate="Email is required">
                        <span class="label-input100">Email Id<span style="color: #ff5e13;">&nbsp;*</span></span>
                        <input class="input100" type="email" id= "emailid" name="email" value="" placeholder="Enter Email">
                        <span class="focus-input100"></span>
                    ...
                    <div class="wrap-input100 validate-input m-b-18" data-validate="Password is required">
                        ...
                        <input id="mobileNo" class="input100" type="text" name="mobileNo" value="" placeholder="Enter Mobile No.">
                        <span class="focus-input100"></span>
                        <x-alert type="mobile-error" />
                    </div>
                    <div class="wrap-input100 validate-input m-b-26" data-validate="Password is required">
                        <span class="label-input100">Password<span style="color: #ff5e13;">&nbsp;*</span></span>
                        <input id="passwd" class="input100" type="password" name="password" placeholder="Enter Password">
                    ...
                    <div class="flex-sb-m w-full text-margins m-l-30" style="justify-content: center">
                        <div>
                            ...
                            <a href="user/login" class="text-primary font-weight-bold">
                                LogIn
                            </a>
                        </div>
                    </div>
	...
	function validate()
	{
		...
		console.log(mobileNo.length && !regPhone.test(mobileNo))
	     if (fname.value.trim()=="")
		{
		...
		if(uname.value.trim().length>20)
		{
			alert("Sorry! Too Long Username!");
			uname.style.border = "solid 2px red";
			return false;
		} */
		if(mobileNo.value.length && !regPhone.test(mobileNo.value))	
		{
