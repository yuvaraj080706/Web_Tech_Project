...
<head>
    ...
    <title>Department Resolved Complaint List</title>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="default_order" class="table table-striped table-bordered display no-wrap" style="width:100%">
                                        ...
                                        <tbody>
                                            <c:forEach var="com" items="${complaintListByDeptartment}">
                                            <tr>
                                                <td>${com.id}</td>
                                                <td>${com.type}</td>
                                                <td>Hi</td>
                                                <td>${com.status}</td>
                                                <td>
                                                	<a href="/dept/viewRes?compid=${com.id}&deptid=${dept_id}" class="btn waves-effect waves-light btn-rounded btn-dark viewBtn">View</a>
                                                </td>
                                            </tr>
                                            </c:forEach>
                                        </tbody>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" width="80%" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td id="detail5"></td>
                                                <th>Complaint Status</th>
                                                <td id="detail6"><font color="green">Solved</font></td>
                                            </tr>
                                        </table>
